...
class OptimizationSizingProblem(ElementwiseProblem):
    def __init__(self):
        ...
        xu = np.array([1000, 2000, 500, 1500, 2000, 500])
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        if el_capacity_kW > 0 and h2_tank_capacity_kg > 0 and fc_capacity_kW > 0:
            ...
            h2_inputs.fuelcell_inputs.fc_capital_cost_per_kW = 3400 * 2 
            h2_inputs.electrolyzer_inputs.el_capital_cost_per_kW = 1400 * 2 
            h2_inputs.h2_tank_cost_kg = 1500 * 2 
        ...
        M_CAD = 1e12
        rp_penalty = M_CAD * max(0, 0.90 - renewable_penetration)
...
if __name__ == "__main__":
    ...
    model.writeResults("Sanirajak_90REP_mlr0_COSTX2")