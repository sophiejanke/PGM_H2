...
class OptimizationSizingProblem(ElementwiseProblem):
    def __init__(self):
        ...
        n_obj = 2
        n_constr = 0
        xl = np.array([200, 4000, 200, 1000, 2000, 3000])
        xu = np.array([1000, 8000, 1000, 4000, 5000, 6000])
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        M_CAD = 1e12
        rp_penalty = M_CAD * max(0, 1.0 - renewable_penetration)
...
if __name__ == "__main__":
    ...
    model.writeResults("chesterfield_100REP")