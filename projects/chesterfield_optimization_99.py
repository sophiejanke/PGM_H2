...
class OptimizationSizingProblem(ElementwiseProblem):
    def __init__(self):
        ...
        n_obj = 2
        n_constr = 0
        xl = np.array([0, 0, 0, 500, 1000, 0])
        xu = np.array([1000, 5000, 1000, 3000, 4000, 4000])
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        M_CAD = 1e12
        rp_penalty = M_CAD * max(0, 0.99 - renewable_penetration)
...
if __name__ == "__main__":
    ...
    model.writeResults("chesterfield_99REP")